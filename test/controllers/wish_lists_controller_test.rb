...
class WishListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wish_list" do
    assert_difference('WishList.count') do
      post wish_lists_url, params: { wish_list: { delivery_date: @wish_list.delivery_date, item_count: @wish_list.item_count, title: @wish_list.title } }, as: :json
    end
  ...
  test "should update wish_list" do
    patch wish_list_url(@wish_list), params: { wish_list: { delivery_date: @wish_list.delivery_date, item_count: @wish_list.item_count, title: @wish_list.title } }, as: :json
    assert_response 200
  end
