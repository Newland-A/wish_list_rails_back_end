...
class WishItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wish_item" do
    assert_difference('WishItem.count') do
      post wish_items_url, params: { wish_item: { color: @wish_item.color, height: @wish_item.height, name: @wish_item.name, weight: @wish_item.weight } }, as: :json
    end
  ...
  test "should update wish_item" do
    patch wish_item_url(@wish_item), params: { wish_item: { color: @wish_item.color, height: @wish_item.height, name: @wish_item.name, weight: @wish_item.weight } }, as: :json
    assert_response 200
  end
